...
```
noaa-tides <command> [arguments] [flags]
```

Run `noaa-tides <command> --help` for the full flag list on any command. This
...
per operation you declare in `noaa-tides/domain.go`.
