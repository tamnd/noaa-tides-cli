...
Most of these come down to network reality or how noaa-tides serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

noaa-tides rate-limits like any public site. noaa-tides already paces
...
Where a surface is gated, noaa-tides reads a cookie or token you supply
...
`noaa-tides`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what noaa-tides actually did
